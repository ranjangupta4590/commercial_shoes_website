...
const Featured = ({
  ...
  return (
    <div>
      <div
        className={`flex items-center justify-items-center lg:flex-col lg:justify-center nike-container ${ifExists ? 'flex-row-reverse' : 'flex-row'}`}
      >
        <div className="max-w-lg lg:max-w-none w-full ma:text-center grid ">
